...
template <> class ITKFoundationCommon_EXPORT AtomicOps<8>
{
public:
...
#else
  struct ITKFoundationCommon_EXPORT AtomicType
  {
    int64_t var;
...
template <> class ITKFoundationCommon_EXPORT AtomicOps<4>
{
public:
