...
//            guards.
//
#  if defined( ITKFoundationCommon_EXPORTS )
//   We are building this library
#    define ITKFoundationCommon_EXPORT_EXPLICIT ITK_TEMPLATE_EXPORT
#  else
//   We are using this library
#    define ITKFoundationCommon_EXPORT_EXPLICIT ITKFoundationCommon_EXPORT
#  endif
namespace itk
{
...
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< bool >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< unsigned char >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< char >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< signed char >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< unsigned short >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< short >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< unsigned int >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< int >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< unsigned long >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< long >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< unsigned long long >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< long long >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< float >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< double >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< std::string >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< std::vector<float> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< std::vector<double> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< std::vector<std::vector<float> > >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< std::vector<std::vector<double> > >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< Array<char> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< Array<int> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< Array<float> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< Array<double> >;
extern template class ITKFoundationCommon_EXPORT_EXPLICIT MetaDataObject< Matrix<double> >;
...
#  undef ITKFoundationCommon_EXPORT_EXPLICIT
#endif
