 ...
 */
ITKFoundationCommon_EXPORT bool IsPrime( unsigned short n );
ITKFoundationCommon_EXPORT bool IsPrime( unsigned int n );
ITKFoundationCommon_EXPORT bool IsPrime( unsigned long n );
ITKFoundationCommon_EXPORT bool IsPrime( unsigned long long n );


/** Return the greatest factor of the decomposition in prime numbers. */
ITKFoundationCommon_EXPORT unsigned short     GreatestPrimeFactor( unsigned short n );
ITKFoundationCommon_EXPORT unsigned int       GreatestPrimeFactor( unsigned int n );
ITKFoundationCommon_EXPORT unsigned long      GreatestPrimeFactor( unsigned long n );
ITKFoundationCommon_EXPORT unsigned long long GreatestPrimeFactor( unsigned long long n );
