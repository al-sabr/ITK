...
template<> ITKFoundationCommon_EXPORT std::ostream & operator<< <double> (std::ostream & os, const Array< double > & arr);
template<> ITKFoundationCommon_EXPORT std::ostream & operator<< <float> (std::ostream & os, const Array< float > & arr);
