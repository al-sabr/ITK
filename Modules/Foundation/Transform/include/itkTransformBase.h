...
#include "ITKFoundationTransformExport.h"
...
//            guards.
//
#  if defined( ITKFoundationTransform_EXPORTS )
//   We are building this library
#    define ITKFoundationTransform_EXPORT_EXPLICIT ITK_TEMPLATE_EXPORT
#  else
//   We are using this library
#    define ITKFoundationTransform_EXPORT_EXPLICIT ITKFoundationTransform_EXPORT
#  endif
namespace itk
{
...
extern template class ITKFoundationTransform_EXPORT_EXPLICIT TransformBaseTemplate< double >;
extern template class ITKFoundationTransform_EXPORT_EXPLICIT TransformBaseTemplate< float >;
#ifdef ITK_HAS_GCC_PRAGMA_DIAG_PUSHPOP
...
#  undef ITKFoundationTransform_EXPORT_EXPLICIT
#endif
