...
ITKInternal_EXPORT unsigned short
GreatestPrimeFactor(unsigned short n);
ITKInternal_EXPORT unsigned int
GreatestPrimeFactor(unsigned int n);
ITKInternal_EXPORT unsigned long
GreatestPrimeFactor(unsigned long n);
ITKInternal_EXPORT unsigned long long
