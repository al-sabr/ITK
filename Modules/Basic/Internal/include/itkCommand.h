...
class ITKInternal_EXPORT Command : public Object
{
public:
...
class ITKInternal_EXPORT CStyleCommand : public Command
{
public:
...
class ITKInternal_EXPORT FunctionCommand : public Command
{
public:
  /** Standard class type aliases. */
